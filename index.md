...
<div class="content-section">
    ...
    <div class="research-tabs">
        <div class="tabs-header">
            <button class="tab-button" onclick="showTab('materials')">Perception & Human–Machine Interfaces
            ...
            <button class="tab-button" onclick="showTab('photonics')">Integrated Photonics </button>
            
        </div>

        <div id="materials" class="tab-content">
        <div style="margin: 40px 0;">
            <h3>Perception & Human–Machine Interfaces</h3>
            <p style="font-size: 1em; color: #666; margin-bottom: 15px;"> My work focuses on the design, implementation, and integration of beyond-RGB imaging and vision-based sensing, enabled by advanced optical materials and compact photonic architectures for robotic and embedded platforms.</p>
            ...
            <ul style="margin-bottom: 20px;">
                ...
                <li>Proposed a Materials Research Society (MRS Spring 2027) symposium on flexible functional materials, optical coatings, and adaptive surfaces for next-generation perception and embodied intelligence.</li>
